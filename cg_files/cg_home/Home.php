    ...
    <div class="navbar-collapse collapse" id="navbarNavDropdown">
        ...
        <ul class="nav mt-lg-0 justify-content-end nav nav-pills ">
			...
			<li class="nav-item active">
                <a class="nav-link" href="../alldevision/alldivision.php"><img src="../../Main_Template/img/vibag.png" alt="Computer Man" style="width:70px;height:30px;"></a>
            </li>
        ...
        <div class="input-group">
            <span class="input-group-btn">
                <span class="btn btn-danger btn-file">
                    Browser<input class="form-control" type="file" name="file" id="imgInp">
...
?>
	...
	<tr class="tr_l tr_r hds" style="background-color:#F7F7F9;border-left:outset; border-left-width:thin;border-left-color:#999999;border-bottom:outset; border-bottom-width:thin;border-bottom-color:#999999">
		<td colspan="3" style="padding:0;"><div style="float:right;padding-top:5px"><span style="color:#999999;"><?php echo $post_data[4]; ?></span>  </div>  <a href="#" style="text-transform:capitalize; text-decoration:none; color:#003399;" onMouseOver="post_name_underLine(<?php echo $postid; ?>)" onMouseOut="post_name_NounderLine(<?php echo $postid; ?>)" id="uname<?php echo $postid; ?>"><h4 class="card-title" style="padding-left:5px"><?php echo $user_name; ?></h4></a></td>
	</tr>
<?php
