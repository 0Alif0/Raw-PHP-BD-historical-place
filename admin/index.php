...
<!--head background-->
    ...
    <div style="position:absolute; left:10%; top:15%;"> <img src="img/fb1.PNG" width="500" height="225"> </div> 
    ...
    <form action="../index.php">
    	<div style="position:absolute;left:62%;top:75%; "> <input type="submit" value="Go back to Voyger " id="go_to_fb"> </div>
    </form>
